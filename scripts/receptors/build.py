...
GLOSSARY = {
 "Ionotropic": ["A receptor that is itself an ion channel", "Transmitter binds, pore opens, ions flow: under a millisecond", "Shuts as soon as the transmitter leaves", "The fast, electrical side of signalling"],
 "Metabotropic": ["A receptor with no pore of its own", "Binding switches on a G protein inside the cell", "Slower to start: tens of milliseconds to seconds", "Keeps acting for seconds to minutes after the transmitter has gone"],
 "GPCR": ["G-protein-coupled receptor: one protein crossing the membrane seven times", "Holds a G protein on the inside; Gs, Gi/o or Gq decides what it does", "The commonest receptor kind in the body", "About a third of all medicines act on one"],
 "Gs": ["The stimulatory G protein", "Switches on adenylyl cyclase: cAMP rises", "cAMP wakes protein kinase A", "Usually excites the cell and strengthens its responses"],
 "Gi/o": ["The inhibitory G protein", "Switches adenylyl cyclase off: cAMP falls", "Its βγ arm opens K⁺ channels and closes Ca²⁺ channels", "Quietens the cell, or stops a terminal releasing"],
 "Gq": ["Switches on phospholipase C, which splits a membrane lipid into IP₃ and DAG", "IP₃ releases Ca²⁺ from the cell's stores", "DAG switches on protein kinase C", "Usually excitation, with a long tail"],
 "cation channel": ["A pore for positive ions: Na⁺ and K⁺, sometimes Ca²⁺", "Open, it lets Na⁺ rush in", "The inside turns more positive, towards the firing threshold", "Excitatory"],
 "chloride channel": ["A pore for Cl⁻", "Open, it lets chloride in", "Holds the membrane at or below rest, so the cell is harder to fire", "Inhibitory in the adult brain"],
 "glutamate receptor": ["AMPA, NMDA and kainate: four subunits round a pore", "Each subunit's clamshell closes on a glutamate", "Opens for cations: fast excitation", "The machinery of learning at the synapse"],
 "Voltage-gated channel": ["Not a receptor: nothing binds it", "A charged helix senses the membrane voltage and pulls the gate open on depolarisation", "Na⁺ channels make the action potential, K⁺ channels end it", "Ca²⁺ channels turn it into transmitter release"],
 "Background channel": ["Open at rest, or gated from inside the cell", "Not opened by a transmitter", "Sets the resting potential", "Sets how easily the neuron fires"],
 "Ca²⁺-activated K⁺ channel": ["A K⁺ channel opened by Ca²⁺ arriving inside", "Follows every burst with a pause", "Sets how fast a neuron can keep firing"],
 "Transporter": ["Not a receptor: a carrier that hauls the transmitter across the membrane", "One molecule per cycle, powered by the Na⁺ gradient", "Reuptake transporters end the signal: what most antidepressants and stimulants block", "Vesicular transporters load the next release"],
 "affinity": ["How tightly a receptor holds its transmitter", "High affinity: occupied at low concentrations, lets go slowly", "Low affinity: needs a lot, lets go fast", "A synapse releases a brief, intense burst: low-affinity receptors answer only to release right in front of them, high-affinity ones sense the background too"],
 "agonist": ["A molecule that binds a receptor and switches it on, as the transmitter does", "Morphine at the μ-opioid receptor", "Nicotine at nicotinic receptors"],
 "antagonist": ["A molecule that binds a receptor and blocks it", "The transmitter can no longer act", "Naloxone at the μ-opioid receptor; antipsychotics at D2; antihistamines at H1"],
 "autoreceptor": ["A receptor on the terminal that released the transmitter", "Senses how much is out there", "Turns release down: the cell's own volume control"],
}
KINDS = {
